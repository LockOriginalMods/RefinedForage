...
import com.LockOriginalMods.refinedforage.block.Generator.PowerEnergy;
        ...
        addDataSlot(new IntReferenceHolder() {
            ...
            public void set(int value) {
                tileEntity.getCapability(CapabilityEnergy.ENERGY).ifPresent(h -> {
                    ...
                    ((PowerEnergy) h).setEnergy(energyStored + (value & 0xffff));
                });
            }
        });
        addDataSlot(new IntReferenceHolder() {
            ...
            public void set(int value) {
                tileEntity.getCapability(CapabilityEnergy.ENERGY).ifPresent(h -> {
                    ...
                    ((PowerEnergy) h).setEnergy(energyStored | (value << 16));
                });
            }
        });
    }
