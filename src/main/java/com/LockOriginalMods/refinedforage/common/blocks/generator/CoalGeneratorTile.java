...
import com.LockOriginalMods.refinedforage.core.util.CustomEnergyStorage;
...
import static com.LockOriginalMods.refinedforage.Registration.COAL_GENERATOR_TILE;
...
public class CoalGeneratorTile extends TileEntity implements ITickableTileEntity {
    ...
    public void tick() {
        ...
        if (counter <= 0) {
            ItemStack stack = itemHandler.getStackInSlot(0);
            if (stack.getItem() == Items.DRIED_KELP_BLOCK)
            {
                itemHandler.extractItem(0, 1, false);
                counter = Config.FIRSTBLOCK_TICKS.get();
                setChanged();
    ...
    private ItemStackHandler createHandler() {
        return new ItemStackHandler(4) {
            ...
            public boolean isItemValid(int slot, @Nonnull ItemStack stack)
                {
                    return stack.getItem() == Items.CHARCOAL || stack.getItem() == Items.COAL || stack.getItem() == Items.COAL_BLOCK || stack.getItem() == Items.DRIED_KELP || stack.getItem() == Items.DRIED_KELP_BLOCK;
                }

            @Nonnull
            @Override
            public ItemStack insertItem(int slot, @Nonnull ItemStack stack, boolean simulate) {
                if ((stack.getItem() == Items.CHARCOAL && stack.getItem() == Items.COAL && stack.getItem() == Items.COAL_BLOCK && stack.getItem() == Items.DRIED_KELP && stack.getItem() == Items.DRIED_KELP_BLOCK)){
                    return stack;
