...
public class SolarindustrialUpdateTickProcedure extends RefinedforageModElements.ModElement {
    public SolarindustrialUpdateTickProcedure(RefinedforageModElements instance) {
        super(instance, 24);
    }
    ...
    public static void executeProcedure(Map<String, Object> dependencies) {
        if (dependencies.get("x") == null) {
            if (!dependencies.containsKey("x"))
                RefinedForage.LOGGER.warn("Failed to load dependency x for procedure SolarindustrialUpdateTick!");
            return;
        }
        if (dependencies.get("y") == null) {
            if (!dependencies.containsKey("y"))
                RefinedForage.LOGGER.warn("Failed to load dependency y for procedure SolarindustrialUpdateTick!");
            return;
        }
        if (dependencies.get("z") == null) {
            if (!dependencies.containsKey("z"))
                RefinedForage.LOGGER.warn("Failed to load dependency z for procedure SolarindustrialUpdateTick!");
            return;
        }
        if (dependencies.get("world") == null) {
            if (!dependencies.containsKey("world"))
                RefinedForage.LOGGER.warn("Failed to load dependency world for procedure SolarindustrialUpdateTick!");
            return;
        }
