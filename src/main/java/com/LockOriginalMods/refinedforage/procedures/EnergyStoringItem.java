...
import com.LockOriginalMods.refinedforage.core.util.EnergyStorageItemImpl;
import com.LockOriginalMods.refinedforage.core.util.TextUtil;
...
public class EnergyStoringItem extends Item {
    public static final ResourceLocation CHARGE = RefinedForage.getId("charge");
