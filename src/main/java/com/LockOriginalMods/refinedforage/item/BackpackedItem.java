...
import com.LockOriginalMods.refinedforage.gui.BackpackGui;
import com.LockOriginalMods.refinedforage.gui.BackpackGuiWindow;
...
public class BackpackedItem extends RefinedforageModElements.ModElement {
    @ObjectHolder("refinedforage:backpacked")
    public static final Item block = null;
    public BackpackedItem(RefinedforageModElements instance) {
        super(instance, 21);
    ...
    public static class ItemCustom extends Item {
        public ItemCustom() {
            super(new Item.Properties().group(RefinedForage.REFINEDFORAGE_GROUP).maxStackSize(1).rarity(Rarity.COMMON));
            setRegistryName("backpacked");
        }
            ...
            if (entity instanceof ServerPlayerEntity) {
                NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
                    ...
                    public ITextComponent getDisplayName() {
                        return new StringTextComponent("Backpacked");
                    }
