...
public class CuttersItem extends RefinedforageModElements.ModElement {
	@ObjectHolder("refinedforage:cutters")
	public static final Item block = null;
	public CuttersItem(RefinedforageModElements instance) {
		super(instance, 79);
	}
