...
import com.LockOriginalMods.refinedforage.procedures.FANUpdateTickProcedure;
...
public class FANBlock extends RefinedforageModElements.ModElement {
    @ObjectHolder("refinedforage:fan")
    public static final Block block = null;
    @ObjectHolder("refinedforage:fan")
    public static final TileEntityType<CustomTileEntity> tileEntityType = null;
    public FANBlock(RefinedforageModElements instance) {
        super(instance, 10);
    ...
    private static class TileEntityRegisterHandler {
        ...
        public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
            event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("fan"));
        }
    }
    ...
    public static class CustomBlock extends Block {
        ...
        public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
            ...
            int z = pos.getZ();
            {
                ...
                FANUpdateTickProcedure.executeProcedure($_dependencies);
            }
            world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 1);
        }
    ...
    public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
        ...
        public ITextComponent getDefaultName() {
            return new StringTextComponent("fan");
        }
        ...
        private final EnergyStorage energyStorage = new EnergyStorage(100000, 200, 200, 0) {
            @Override
