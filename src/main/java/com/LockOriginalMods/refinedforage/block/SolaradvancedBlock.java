...
import com.LockOriginalMods.refinedforage.procedures.SolaradvancedUpdateTickProcedure;
...
public class SolaradvancedBlock extends RefinedforageModElements.ModElement {
    @ObjectHolder("refinedforage:solaradvanced")
    public static final Block block = null;
    public SolaradvancedBlock(RefinedforageModElements instance) {
        super(instance, 26);
    }
    ...
    public static class CustomBlock extends Block {
        ...
        public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
            ...
            int z = pos.getZ();
            {
                ...
                SolaradvancedUpdateTickProcedure.executeProcedure($_dependencies);
            }
            world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 1);
        }
    }
