...
import com.LockOriginalMods.refinedforage.procedures.SolarindustrialUpdateTickProcedure;
...
public class SolarindustrialBlock extends RefinedforageModElements.ModElement {
    @ObjectHolder("refinedforage:solarindustrial")
    public static final Block block = null;
    public SolarindustrialBlock(RefinedforageModElements instance) {
        super(instance, 25);
    }
    ...
    public static class CustomBlock extends Block {
        public CustomBlock() {
            ...
            setRegistryName("solarindustrial");
        }
        ...
        public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
            ...
            int z = pos.getZ();
            {
                ...
                SolarindustrialUpdateTickProcedure.executeProcedure($_dependencies);
            }
            world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 1);
        }
    }
