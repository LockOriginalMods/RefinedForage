...
import com.LockOriginalMods.refinedforage.procedures.SolarspectralUpdateTickProcedure;
...
public class SolarspectralBlock extends RefinedforageModElements.ModElement {
    @ObjectHolder("refinedforage:solarspectral")
    public static final Block block = null;
    public SolarspectralBlock(RefinedforageModElements instance) {
        super(instance, 29);
    }
    ...
    public static class CustomBlock extends Block {
        ...
        public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
            ...
            int z = pos.getZ();
            {
                ...
                SolarspectralUpdateTickProcedure.executeProcedure($_dependencies);
            }
            world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 1);
        }
    }
