...
import com.LockOriginalMods.refinedforage.procedures.BatteryUpdateTickProcedure;
...
public class BatteryBlock extends RefinedforageModElements.ModElement {
    @ObjectHolder("refinedforage:batteryblock")
    public static final Block block = null;
    @ObjectHolder("refinedforage:batteryblock")
    public static final TileEntityType<CustomTileEntity> tileEntityType = null;
    public BatteryBlock(RefinedforageModElements instance) {
        super(instance, 14);
    ...
    private static class TileEntityRegisterHandler {
        ...
        public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
            event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("batteryblock"));
        }
    }
    ...
    public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
        ...
        public ITextComponent getDefaultName() {
            return new StringTextComponent("batteryblock");
        }
