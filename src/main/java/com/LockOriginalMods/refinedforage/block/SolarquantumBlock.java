...
import com.LockOriginalMods.refinedforage.procedures.SolarquantumUpdateTickProcedure;
...
public class SolarquantumBlock extends RefinedforageModElements.ModElement {
    @ObjectHolder("refinedforage:solarquantum")
    public static final Block block = null;
    public SolarquantumBlock(RefinedforageModElements instance) {
        super(instance, 28);
    }
    ...
    public static class CustomBlock extends Block {
        ...
        public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
            ...
            int z = pos.getZ();
            {
                ...
                SolarquantumUpdateTickProcedure.executeProcedure($_dependencies);
            }
            world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 1);
        }
    }
