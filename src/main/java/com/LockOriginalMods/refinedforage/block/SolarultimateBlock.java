...
import com.LockOriginalMods.refinedforage.procedures.SolarultimateUpdateTickProcedure;
...
public class SolarultimateBlock extends RefinedforageModElements.ModElement {
    @ObjectHolder("refinedforage:solarultimate")
    public static final Block block = null;
    public SolarultimateBlock(RefinedforageModElements instance) {
        super(instance, 27);
    }
    ...
    public static class CustomBlock extends Block {
        ...
        public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
            ...
            int z = pos.getZ();
            {
                ...
                SolarultimateUpdateTickProcedure.executeProcedure($_dependencies);
            }
            world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 1);
        }
    }
