...
import com.LockOriginalMods.refinedforage.item.CuttersItem;
import com.LockOriginalMods.refinedforage.item.HammerItem;
...
public class VillagerInit {
    ...
    public static final RegistryObject<PointOfInterestType> BOTANIST_POI = POINT_OF_INTEREST_TYPES.register("botanist",
            () -> new PointOfInterestType("botanist", PointOfInterestType.getBlockStates(BlockInit.WOODWORKING_TABLE.get()), 1, 1));

    public static final RegistryObject<VillagerProfession> BOTANIST_PROF = VILLAGER_PROFESSIONS.register("botanist",
            () -> new VillagerProfession("botanist", BOTANIST_POI.get(), ImmutableSet.of(), ImmutableSet.of(), SoundEvents.VILLAGER_WORK_FARMER));
    ...
    public static final RegistryObject<PointOfInterestType> ENGINEER_POI = POINT_OF_INTEREST_TYPES.register("engineer",
            () -> new PointOfInterestType("engineer", PointOfInterestType.getBlockStates(BlockInit.BLUE_CRAFTING.get()), 1, 1));

    public static final RegistryObject<VillagerProfession> ENGINEER_PROF = VILLAGER_PROFESSIONS.register("engineer",
            () -> new VillagerProfession("engineer", ENGINEER_POI.get(), ImmutableSet.of(), ImmutableSet.of(), SoundEvents.VILLAGER_WORK_FARMER));
    ...
    public static void fillTradeData() {
        ...
        VillagerTrades.TRADES.put(BOTANIST_PROF.get(), toIntMap(ImmutableMap.of(1, Level1, 2, Level2, 3, Level3, 4, Level4, 5, Level5)));

        //engineer
        VillagerTrades.ITrade[] engineerLevel1 = new VillagerTrades.ITrade[]{
                new VillagerTrades.ItemsForEmeraldsTrade(HammerItem.block, 13, 1, 100, 9),
                new VillagerTrades.ItemsForEmeraldsTrade(CuttersItem.block, 10, 1, 100, 9),
        };
                VillagerTrades.ITrade[]engineerLevel2 = new VillagerTrades.ITrade[]{
                        new VillagerTrades.ItemsForEmeraldsTrade(ItemInit.COPPERWIRE_COIL.get(), 8, 2, 100, 9),
                };
           VillagerTrades.TRADES.put(ENGINEER_PROF.get(), toIntMap(ImmutableMap.of(1, engineerLevel1, 2, engineerLevel2)));
    }
