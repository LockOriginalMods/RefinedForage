...
public class RefinedForage
{
    ...
    public RefinedForage() {
        ...
        FMLJavaModLoadingContext.get().getModEventBus().addGenericListener(IRecipeSerializer.class, ModRegistry::registerRecipeSerializers);
    ...
    private void setupClient(final FMLClientSetupEvent event) {
        ...
        ScreenManager.register(CTR_GRINDER, ScreenGrinder::new);
    }
