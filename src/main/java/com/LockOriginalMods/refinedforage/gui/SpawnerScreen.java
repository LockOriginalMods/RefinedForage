...
import com.LockOriginalMods.refinedforage.core.util.Networking;
import com.LockOriginalMods.refinedforage.core.util.PacketSpawn;
...
public class SpawnerScreen extends Screen {
    ...
    private ResourceLocation GUI = new ResourceLocation(RefinedForage.MOD_ID, "textures/gui/spawner_gui.png");
